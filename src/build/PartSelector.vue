...
/* eslint-disable */
<template>
  <div class="part" :class="props.postition">
    <router-link :to="{
      name: 'Parts',
    ...
    <!-- <span v-pin.bottom.right
    class="sale" v-show="selectedPart.onSale">Sale! {{ userName }}</span> -->
...
const pinPadding = ref('5px');
const props = defineProps({
  parts: { type: Array, required: true },
  postition: {
    type: String,
    required: true,
    validator(value) { return ['left', 'right', 'top', 'bottom', 'center'].includes(value); },
  },
});
...
onMounted(() => emit('partSelected', selectedPart));
