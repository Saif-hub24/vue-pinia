<template>
  <div class="content">
    ...
    <div class="top-row">
      <div class="top part">
        <div class="robot-name">{{ selectedRobot.head.title }} <span class="sale"
            v-show="selectedRobot.head.onSale">(Sale)</span></div>
  ...
  computed: {
    selectedRobot() {
      return {
        ...
        torsos: this.availableParts.torsos[this.selectedTorsoIndex],
        rightArm: this.availableParts.arms[this.selectedRightArmIndex],
        base: this.availableParts.arms[this.selectedBaseIndex],
      };
    },
  },
